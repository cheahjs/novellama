...
import { FiChevronLeft, FiChevronRight, FiPlus, FiList, FiTrash2, FiMoreVertical } from 'react-icons/fi';
  ...
  return (
    <div className="flex items-center justify-between py-4 relative">
      <button
        ...
        className={`flex items-center space-x-2 px-4 py-2 rounded-lg ${currentIndex <= 0
      ...
      <div className="text-center flex-1 mx-4">
        <div className="flex justify-center items-center gap-2">
          ...
          {currentIndex === totalChapters - 1 && totalChapters > 0 && onDeleteLatest && (
            ...
            <div className="py-2 max-h-96 overflow-y-auto">
              {chapters.map((chapter, index) => (
                <button
                  ...
                  className={`w-full px-4 py-2 text-left hover:bg-gray-700 ${index === currentIndex ? 'bg-gray-700' : ''
                    }`}
                >
